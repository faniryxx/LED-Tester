...
ExemplesGraphiques::ExemplesGraphiques()
{

}

void ExemplesGraphiques::creerGraphEfficacite(QChartView *chartViewEfficacite)
{
    //EFFICACITE
...
void ExemplesGraphiques::creerGraphStabilite(QChartView *chartViewStabilite)
{
    //STABILITE
...
void ExemplesGraphiques::creerGraphCouleurs(QChartView *chartViewCouleurs)
{
    //COULEURS
...
void ExemplesGraphiques::creerGraphTemperature(QChartView *chartViewTemperature)
{
    //TEMPERATURE
...
void ExemplesGraphiques::GenererExemplesCharts(QChartView *chartViewEfficacite, QChartView *chartViewStabilite, QChartView *chartViewCouleurs, QChartView *chartViewTemperature)
{
